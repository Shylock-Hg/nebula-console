...
func (o *Operation) SetPrompt(s PromptFunc) {
	o.buf.SetPrompt(s)
}
...
func (o *Operation) PasswordEx(prompt PromptFunc, l Listener) ([]byte, error) {
...
func (o *Operation) Password(prompt PromptFunc) ([]byte, error) {
