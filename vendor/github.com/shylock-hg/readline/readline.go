...
func New(prompt PromptFunc) (*Instance, error) {
...
func (i *Instance) SetPrompt(s PromptFunc) {
...
func (i *Instance) ReadPasswordEx(prompt PromptFunc, l Listener) ([]byte, error) {
	return i.Operation.PasswordEx(prompt, l)
}

func (i *Instance) ReadPassword(prompt PromptFunc) ([]byte, error) {
