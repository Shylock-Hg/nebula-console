...
import (
	...
	nebula0 "github.com/shylock-hg/nebula-go2.0/nebula"
...
func NewGraphServiceProcessor(handler GraphService) *GraphServiceProcessor {
  self14 := &GraphServiceProcessor{handler:handler, processorMap:make(map[string]thrift.ProcessorFunction)}
  self14.processorMap["authenticate"] = &graphServiceProcessorAuthenticate{handler:handler}
  self14.processorMap["signout"] = &graphServiceProcessorSignout{handler:handler}
  self14.processorMap["execute"] = &graphServiceProcessorExecute{handler:handler}
  self14.processorMap["executeJson"] = &graphServiceProcessorExecuteJson{handler:handler}
  return self14
}
